<!-- Kicker: Crianza · Trucos que funcionan -->
<!-- Entradilla (para el índice /blog y base de la meta description): El diente se cae a las ocho y media de la tarde, justo cuando ya no queda energía para inventar magia. Esto es lo que hace donbigotes.app en los dos minutos que tienes antes de que se apague la luz. -->
<!-- Meta: Lectura de 5 minutos · Actualizado en agosto de 2026 -->
...
1. **Escribes su nombre y un par de detalles.** Qué diente se le ha caído (palita de arriba, muela, colmillo), si es el primero o el último, y una cosa que hace especialmente bien.
2. **La carta se escribe sola.** En cuestión de segundos aparece redactada en primera persona, con su nombre dentro del texto y la hazaña concreta de esa noche.
3. **La dejas lista.** Imprimir, o guardar el PDF y mandarlo a imprimir a cualquier sitio. Debajo de la almohada, y a dormir.
